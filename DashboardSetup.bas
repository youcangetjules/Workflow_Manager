Attribute VB_Name = "DashboardSetup"
'===============================================================================
...
Private Sub TestDashboardFunctionality()
    ...
    Else
        MsgBox "Sandbox environment not found. Please run MSCANBASH_Flow_Sandbox.InitializeSandbox() first.", vbExclamation, "Test Result"
    End If
