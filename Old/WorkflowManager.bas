Attribute VB_Name = "WorkflowManager"
'===============================================================================
...
Sub ProcessWorkflowEmails(control As IRibbonControl)
...
Sub ShowFormatExamples(control As IRibbonControl)
    ShowFormatExamples
End Sub

Sub TestDatabaseConnection(control As IRibbonControl)
    TestDatabaseConnection
End Sub

Sub CreateDatabaseTable(control As IRibbonControl)
    CreateDatabaseTable
End Sub

Sub GenerateSampleData(control As IRibbonControl)
    GenerateSampleData
End Sub
