...
Public Sub SetupDashboard()
    ...
    setupMsg = setupMsg & "1. Load BASHWorkflowDashboard.vba module" & vbCrLf
...
Private Sub LoadDashboardModule()
    ...
    MsgBox "Please manually load the BASHWorkflowDashboard.vba module into your Outlook VBA project." & vbCrLf & vbCrLf & _
           "Steps:" & vbCrLf & _
           "1. Open VBA Editor (Alt+F11)" & vbCrLf & _
           "2. Right-click on your project" & vbCrLf & _
           "3. Select 'Import File...'" & vbCrLf & _
           "4. Select BASHWorkflowDashboard.vba", vbInformation, "Load Module"
...
' Check if sandbox is available (copied from BASHWorkflowDashboard.vba)
