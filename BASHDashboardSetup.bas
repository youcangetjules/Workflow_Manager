Attribute VB_Name = "BASHDashboardSetup"
'===============================================================================
...
Public Sub SetupDashboard()
    ...
    setupMsg = setupMsg & "1. Load BASHWorkflowDashboard.bas module" & vbCrLf
...
Private Sub LoadDashboardModule()
    ...
    MsgBox "Please manually load the BASHWorkflowDashboard.bas module into your Outlook VBA project." & vbCrLf & vbCrLf & _
           "Steps:" & vbCrLf & _
           "1. Open VBA Editor (Alt+F11)" & vbCrLf & _
           "2. Right-click on your project" & vbCrLf & _
           "3. Select 'Import File...'" & vbCrLf & _
           "4. Select BASHWorkflowDashboard.bas", vbInformation, "Load Module"
...
' Check if sandbox is available (copied from BASHWorkflowDashboard.bas)
